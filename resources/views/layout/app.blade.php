...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('../../vendors/dist/img/AdminLTELogo.png') }}">
    <link rel="stylesheet"
                        ...
                        <div class="text-center">
                            ...
                            <div class="media">
                                <div class="media-body">
                                    ...
                                    <p style="font-size: 12px">{{ Auth::user()->jabatan }}</p>
                                </div>
                            </div>
                        </div>
                        <hr>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <b href="../../index3.html" class="brand-link">
                <img src="{{ asset('../../vendors/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo"
                    class="brand-image image-circle" style="opacity: .8">
